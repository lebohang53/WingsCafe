            ...
            <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8">
                <div className="space-y-5 max-w-4xl mx-auto text-center">
                    ...
                    <h2 className="text-4xl text-gray-800 font-extrabold mx-auto md:text-5xl">
                        Wings Cafe with<span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4F46E5] to-[#E114E5]"> Delicious Food</span>
                    </h2>
                    <p className="max-w-2xl mx-auto">
                     With Wings Cafe Inventory, You can Manage your Stock and Monitor Your Stock Levels
                    </p>
